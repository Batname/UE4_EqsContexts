...
EqsContextsRootPath=/media/bat/SecondSSD/Projects/Unreal/EqsContexts

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/EqsContexts/EqsContexts.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(EqsContextsSource.pri)
include(EqsContextsHeader.pri)
include(EqsContextsConfig.pri)
include(EqsContextsIncludes.pri)
include(EqsContextsDefines.pri)
...
EqsContexts-Linux-Debug.commands = $$build EqsContexts Linux Debug  -project="\"$$gameProjectFile\"" $$args
EqsContexts-Linux-DebugGame.commands = $$build EqsContexts Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EqsContexts-Linux-Shipping.commands = $$build EqsContexts Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EqsContexts-Linux-Test.commands = $$build EqsContexts Linux Test  -project="\"$$gameProjectFile\"" $$args
EqsContexts.commands = $$build EqsContexts Linux Development  -project="\"$$gameProjectFile\"" $$args

EqsContextsEditor-Linux-Debug.commands = $$build EqsContextsEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
EqsContextsEditor-Linux-DebugGame.commands = $$build EqsContextsEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EqsContextsEditor-Linux-Shipping.commands = $$build EqsContextsEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EqsContextsEditor-Linux-Test.commands = $$build EqsContextsEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
EqsContextsEditor.commands = $$build EqsContextsEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	EqsContexts-Linux-Debug \
	EqsContexts-Linux-DebugGame \
	EqsContexts-Linux-Shipping \
	EqsContexts-Linux-Test \
	EqsContexts \
	EqsContextsEditor-Linux-Debug \
	EqsContextsEditor-Linux-DebugGame \
	EqsContextsEditor-Linux-Shipping \
	EqsContextsEditor-Linux-Test \
	EqsContextsEditor \
